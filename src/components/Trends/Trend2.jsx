...
const Trend2 = () => {
    return (
        <div className='trend2 cursor-pointer hover:scale-[1.02] transition-all relative rounded-[10px] w-full h-[380px] xl:h-[340px] lg:h-[280px] bg-no-repeat bg-cover bg-center' style={{
